...
**Version:** 6.27 **Datei:** `index.html` (Single-File PWA, intern aus 3 Teilen gebaut) **Hosting:** GitHub Pages (statisch, kein Backend)
...
### v6.27 — letzte Version dieses Chats
...
*Dokumentation zuletzt aktualisiert: August 2026, basierend auf Code-Stand **v6.27**, gegen die reale Datei verifiziert (nicht rekonstruiert).*
